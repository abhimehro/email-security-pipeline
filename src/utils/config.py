...
class Config:
    ...
    def _validate_webhook_alerts(self) -> List[str]:
    ...
    def _validate_slack_alerts(self) -> List[str]:
        """Validate slack alert configurations."""
        errors = []
    ...
    def _validate_alerts(self) -> List[str]:
        ...
        errors = []
        errors.extend(self._validate_webhook_alerts())
        errors.extend(self._validate_slack_alerts())
