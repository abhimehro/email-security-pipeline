    ...
    def _check_urls(self, content: str) -> Tuple[float, List[str]]:
        ...
        for url in urls:
            try:
                ...
                # Check against suspicious patterns using combined regex (faster & case-insensitive)
                # This replaces the loop over SUSPICIOUS_URL_PATTERNS and the manual shortener check
