...
class AppRunner:
    ...
    def _handle_missing_config_interactive(self) -> None:
        ...
        try:
            ...
            print(
                f"{Colors.GREY}(This will help you configure your email provider){Colors.RESET}"
            )
    ...
    def validate_config(self) -> None:
        ...
        try:
            ...
            if errors:
                ...
                print(
                    f"{Colors.GREY}The following issues must be resolved in your .env file before starting:{Colors.RESET}\n"
                )
            ...
            print(
                f"{Colors.YELLOW}Warning: Could not validate configuration: {e}{Colors.RESET}"
            )
