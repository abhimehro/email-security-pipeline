...
class TestSanitization(unittest.TestCase):
    ...
    def test_redact_email_exception_fallback(self):
        ...
        email = FakeEmail("user@example.com")
        self.assertEqual(redact_email(email), "user@example.com")
    ...
    def test_newline_sanitization(self):
        ...
        self.assertEqual(sanitize_for_logging("Line 1\nLine 2"), "Line 1\\nLine 2")
        self.assertEqual(sanitize_for_logging("Line 1\rLine 2"), "Line 1\\rLine 2")
        self.assertEqual(sanitize_for_logging("Line 1\r\nLine 2"), "Line 1\\r\\nLine 2")
    ...
    def test_truncation_edge_cases(self):
        ...
        # One char over
        self.assertEqual(
            sanitize_for_logging(text + "1", max_length=10), "1234567890..."
        )
