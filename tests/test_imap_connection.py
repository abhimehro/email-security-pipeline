...
class TestIMAPConnectionFetchBatch(unittest.TestCase):
    ...
    def test_fetch_batch_success(self, mock_parse):
        ...
        mock_imap.fetch.assert_called_once_with(b"1,2,3", "(RFC822)")
        self.assertEqual(len(result), 2)
        self.assertEqual(result[0], ("1", b"raw1"))
        self.assertEqual(result[1], ("2", b"raw2"))

    def test_fetch_batch_fetch_error_status(self):
    ...
    @patch.object(IMAPConnection, "_parse_email_payload")
    def test_fetch_batch_parsing_skips_none(self, mock_parse):
    ...
    def test_fetch_batch_exception_handling(self):
