...
- [x] Complete test cases for missing `_process_singlepart_body` error handlers.
- [x] Run coverage and full test suite successfully.
- [x] Complete PR workflow and documentation.
